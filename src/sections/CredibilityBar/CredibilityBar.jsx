...
export default function CredibilityBar() {
  const { highlight, label, cta1, cta2 } = credibilityBarContent;

  return (
    <section
      className="trusted"
      data-od-id="credibilidade-bar"
      aria-label="Experiência e contato"
    >
      <div className="container trusted-content">
        <div className="trusted-message">
          <strong className="trusted-highlight" aria-label="Mais de 10 anos">
            {highlight}
          </strong>
          <p>{label}</p>
        </div>
        ...
        <a
          className="trusted-cta trusted-tg"
          href={cta1.href}
          target="_blank"
        ...
        <a
          className="trusted-cta trusted-wp"
          href={cta2.href}
          target="_blank"
          rel="noreferrer noopener"
          title={cta2.label}
